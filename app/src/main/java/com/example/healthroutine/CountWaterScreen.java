...
public class CountWaterScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView img1, img2, img3, img4, img5, img6, img7, img8,countWater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countWater = (ImageView) findViewById(R.id.countWaterBtn);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.countWaterBtn:
                ...
                Toast.makeText(this, "save your counter Cups!", Toast.LENGTH_SHORT).show();
